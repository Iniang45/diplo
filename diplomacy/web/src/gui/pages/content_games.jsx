...
export class ContentGames extends React.Component {
    ...
    this.getPage()
      ...
      .then((allPossibleOrders) => {
        ...
        this.getPage().load(
          ...
          <ContentGame
            data={networkGame.local}
            channel={this.getPage().channel}
          />,
  ...
  wrapGameData(gameData) {
    return new InlineGameView(
      this.getPage(),
      gameData,
      this.getPage().availableMaps
    );
  }
      ...
      <button
        ...
        onClick={() =>
          this.getPage().dialog((onClose) => (
            <GameCreationWizard
              availableMaps={this.getPage().availableMaps}
              onCancel={onClose}
  ...
  render() {
    ...
    return (
      <main>
        ...
        <Navigation
          title={title}
          afterTitle={this.gameCreationButton()}
          username={page.channel.username}
          navigation={navigation}
        />
        <Tabs
          menu={["find", "my-games"]}
          titles={["Find", "My Games"]}
