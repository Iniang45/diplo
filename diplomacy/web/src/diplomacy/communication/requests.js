...
export const REQUESTS = {
  ...
  models: {
    ...
    set_dummy_powers: {
      level: STRINGS.GAME,
      model: { username: null, power_names: null },
    },
    set_game_state: {
      level: STRINGS.GAME,
    ...
    set_orders: {
      level: STRINGS.GAME,
      model: { power_name: null, orders: null },
    },
    set_wait_flag: {
      level: STRINGS.GAME,
      model: { power_name: null, wait: null },
    },
    synchronize: {
      level: STRINGS.GAME,
      phase_dependent: false,
  ...
  isPhaseDependent: function (name) {
    ...
    return (
      model.level === STRINGS.GAME &&
      (!model.hasOwnProperty("phase_dependent") || model.phase_dependent)
    );
  },
